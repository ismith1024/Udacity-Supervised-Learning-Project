...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k+kn}{import} \PY{n+nn}{sys}
        \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Python version: }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n}{sys}\PY{o}{.}\PY{n}{version}\PY{p}{)}
\end{Verbatim}
...
census database.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} Import libraries necessary for this project}
...
formatted.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} Total number of records}
         ...
         \PY{c+c1}{\PYZsh{} Classes are:}
         \PY{c+c1}{\PYZsh{}    \PYZsq{}\PYZlt{}=50K\PYZsq{}}
         \PY{c+c1}{\PYZsh{}    \PYZsq{}\PYZgt{}50K\PYZsq{}}
         \PY{n}{class1} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZlt{}=50K}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{class2} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZgt{}50K}\PY{l+s+s1}{\PYZsq{}}
         
         \PY{n}{n\PYZus{}greater\PYZus{}50k} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{n}{data}\PY{o}{.}\PY{n}{income} \PY{o}{==} \PY{n}{class2}\PY{p}{]}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
         
         \PY{c+c1}{\PYZsh{} Number of records where individual\PYZsq{}s income is at most \PYZdl{}50,000}
         \PY{n}{n\PYZus{}at\PYZus{}most\PYZus{}50k} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{n}{data}\PY{o}{.}\PY{n}{income} \PY{o}{==} \PY{n}{class1}\PY{p}{]}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
         
         \PY{c+c1}{\PYZsh{} Percentage of individuals whose income is more than \PYZdl{}50,000}
         \PY{n}{greater\PYZus{}percent} \PY{o}{=} \PY{n}{n\PYZus{}greater\PYZus{}50k} \PY{o}{/} \PY{p}{(}\PY{n}{n\PYZus{}greater\PYZus{}50k} \PY{o}{+} \PY{n}{n\PYZus{}at\PYZus{}most\PYZus{}50k}\PY{p}{)}
...
Percentage of individuals making more than \$50,000: 0.2478439697492371\%
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{}sanity check \PYZhy{}\PYZhy{} n\PYZus{}greater\PYZus{}50k + n\PYZus{}at\PYZus{}most\PYZus{}50k == n\PYZus{}records}
         \PY{n+nb}{print}\PY{p}{(}\PY{p}{(}\PY{n}{n\PYZus{}greater\PYZus{}50k} \PY{o}{+} \PY{n}{n\PYZus{}at\PYZus{}most\PYZus{}50k}\PY{p}{)} \PY{o}{==} \PY{n}{n\PYZus{}records}\PY{p}{)}
\end{Verbatim}
...
the range of the values present and how they are distributed.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} Split the data into features and target label}
...
distributed.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} Log\PYZhy{}transform the skewed features}
...
for this.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} Import sklearn.preprocessing.StandardScaler}
...
with "\textgreater{}50K" to \texttt{1}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{} One\PYZhy{}hot encode the \PYZsq{}features\PYZus{}log\PYZus{}minmax\PYZus{}transform\PYZsq{} data using pandas.get\PYZus{}dummies()}
         ...
         \PY{n}{income} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{get\PYZus{}dummies}\PY{p}{(}\PY{n}{features\PYZus{}log\PYZus{}minmax\PYZus{}transform}\PY{p}{,} \PY{n}{drop\PYZus{}first}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
        ...
        \PY{n}{accuracy} \PY{o}{=} \PY{k+kc}{None}
        \PY{n}{recall} \PY{o}{=} \PY{k+kc}{None}
        \PY{n}{precision} \PY{o}{=} \PY{k+kc}{None}
...
\texttt{beta} parameter!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} TODO: Import two metrics from sklearn \PYZhy{} fbeta\PYZus{}score and accuracy\PYZus{}score}
        ...
        \PY{l+s+sd}{    \PYZsq{}\PYZsq{}\PYZsq{}}
            ...
            \PY{n}{learner} \PY{o}{=} \PY{k+kc}{None}
            \PY{n}{end} \PY{o}{=} \PY{n}{time}\PY{p}{(}\PY{p}{)} \PY{c+c1}{\PYZsh{} Get end time}
            
            \PY{c+c1}{\PYZsh{} TODO: Calculate the training time}
            \PY{n}{results}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{train\PYZus{}time}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
            ...
            \PY{n}{start} \PY{o}{=} \PY{n}{time}\PY{p}{(}\PY{p}{)} \PY{c+c1}{\PYZsh{} Get start time}
            \PY{n}{predictions\PYZus{}test} \PY{o}{=} \PY{k+kc}{None}
            \PY{n}{predictions\PYZus{}train} \PY{o}{=} \PY{k+kc}{None}
            \PY{n}{end} \PY{o}{=} \PY{n}{time}\PY{p}{(}\PY{p}{)} \PY{c+c1}{\PYZsh{} Get end time}
            
            \PY{c+c1}{\PYZsh{} TODO: Calculate the total prediction time}
            \PY{n}{results}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{pred\PYZus{}time}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
                    
            \PY{c+c1}{\PYZsh{} TODO: Compute accuracy on the first 300 training samples which is y\PYZus{}train[:300]}
            \PY{n}{results}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{acc\PYZus{}train}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
                
            \PY{c+c1}{\PYZsh{} TODO: Compute accuracy on test set using accuracy\PYZus{}score()}
            \PY{n}{results}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{acc\PYZus{}test}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
            
            \PY{c+c1}{\PYZsh{} TODO: Compute F\PYZhy{}score on the the first 300 training samples using fbeta\PYZus{}score()}
            \PY{n}{results}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{f\PYZus{}train}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
                
            \PY{c+c1}{\PYZsh{} TODO: Compute F\PYZhy{}score on the test set which is y\PYZus{}test}
            \PY{n}{results}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{f\PYZus{}test}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{k+kc}{None}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} TODO: Import the three supervised learning models from sklearn}
        ...
        \PY{n}{clf\PYZus{}A} \PY{o}{=} \PY{k+kc}{None}
        \PY{n}{clf\PYZus{}B} \PY{o}{=} \PY{k+kc}{None}
        \PY{n}{clf\PYZus{}C} \PY{o}{=} \PY{k+kc}{None}
        ...
        \PY{n}{samples\PYZus{}100} \PY{o}{=} \PY{k+kc}{None}
        \PY{n}{samples\PYZus{}10} \PY{o}{=} \PY{k+kc}{None}
        \PY{n}{samples\PYZus{}1} \PY{o}{=} \PY{k+kc}{None}
